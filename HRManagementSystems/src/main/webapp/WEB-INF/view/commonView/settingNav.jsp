		...
		<!--   Start setting Links -->
			<nav class="navbar navbar-expand-lg"
				...
				<ul class="nav navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="admin/payroll/calBasicSalary">Salary Structure</a>
					<li class="nav-item"><a class="nav-link" href="#">Forms</a></li>
					<li class="nav-item"><a class="nav-link" href="#">Reports</a></li>
					<li class="nav-item"><a class="nav-link" href="payroll/taxCalculator">Tax</a></li>
